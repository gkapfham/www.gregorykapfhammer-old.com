...
_popovers/paper_reference.html cite="McMinn2016b" %} being one paper, with
...
cite="Kukunas2010a" %} describing search-based solutions to software engineering
challenges. Recent papers like {% include_cached _popovers/paper_reference.html
cite="Alsharif2019" %} present ways to involve human testers when studying the
usefulness of tests that were automatically generated by search-based
techniques.
</li>
<p>
